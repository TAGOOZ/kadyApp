// Menu catalog models — mirrors Supabase `menu_categories` / `menu_items`
// (supabase/migrations/0001_init.sql) plus the client-side item configuration
// used by the item detail sheet and cart math.
...
class ItemConfig {
  ...
  int get sizeDeltaEgp => sizeDeltasEgp[sizeIndex.clamp(0, 2)];
